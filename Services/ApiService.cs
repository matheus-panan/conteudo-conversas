...
namespace painel_conversas.Services
{
    public class ApiService
    {
        ...
        public async Task<List<ContactItems>> GetContact()
        {
            ...
            var result = JsonSerializer.Deserialize<Contact>(content, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });

            if (result?.Items == null)
                return new List<ContactItems>();
